...
def run_experiment(experiment_definition_name, rows_per_attack, algorithms):
    experiment_name = experiment_definition_name + str(rows_per_attack)
...
def run_experiments(exp_definitions, algorithms):
    ...
    for exp_definition in experiments:
        ...
        for rows_per_it in iterations:
            run_experiment(exp_definition, rows_per_it, algorithms)
